...
In the previous two posts ([part1](https://learniningwithsckinta.netlify.com/post/network_analysis), [part2](https://learniningwithsckinta.netlify.com/post/network_analysis_part2-2)), we discussed about IGRAPH object and how to manipulate, measure and cluster it. In this part3 of network analysis series, I will focus on the network work visualization.  
