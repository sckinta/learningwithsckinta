...
## AWS
In 2017 rstudio artical, aws.s3 package is used for communication between app and AWS.S3 external database. aws.s3 can be installed through. 
...
```{r, echo=F, out.width = "300px", out.height="150px"}
