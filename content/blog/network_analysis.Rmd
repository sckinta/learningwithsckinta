...
**Degree** : the number of adajant vertex.  
...
## Create a graph
There are many ways to create graph from scratch. Here we are going to introduce four most popular ways to create graph using igraph package.
