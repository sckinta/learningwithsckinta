...
mtcars = read_delim("mtcars.tsv", delim = "\t")
class(mtcars)
...
mtcars = pd.read_csv('mtcars.tsv', sep="\t")
...
untidy_mtcars1 = read_delim("untidy_mtcars1.tsv", delim="\t")
```
...
**Python version:**
```{python, eval=F}
untidy_mtcars1 = pd.read_csv("untidy_mtcars1.tsv",sep="\t")
