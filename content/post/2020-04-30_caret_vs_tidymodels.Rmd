...
## 5. fit model
Here is the step where tidymodel and caret start to diverge in syntax. 
Typically, tidymodel builds a model using `workflow` pipe which specifies formular/recipe and model, while caret uses `train` to fit model.
